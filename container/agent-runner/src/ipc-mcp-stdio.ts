...
const chatJid = process.env.OXICLAW_CHAT_JID!;
const groupFolder = process.env.OXICLAW_GROUP_FOLDER!;
const isMain = process.env.OXICLAW_IS_MAIN === '1';
