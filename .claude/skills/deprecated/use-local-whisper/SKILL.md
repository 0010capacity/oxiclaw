...
deprecated: true
note: Use the /add-voice-transcription skill with the local-whisper option instead.
---

# Use Local Whisper (DEPRECATED)

> **This skill is deprecated.** Use `/add-voice-transcription` instead, which supports both OpenAI Whisper API and local whisper.cpp modes.
